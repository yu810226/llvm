...
//
// This is a backport from LLVM 4.0 for SYCL usage
//===----------------------------------------------------------------------===//

#include "llvm/SYCL.h"

// This file exports a single function: llvm::sycl::itanium_demangle.
...
char *
llvm::sycl::itaniumDemangle(const char *mangled_name, char *buf, size_t *n,
                            int *status) {
